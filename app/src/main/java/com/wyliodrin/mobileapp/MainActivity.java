...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button sendButtonOn = (Button) findViewById(R.id.buttonon);
        ...
        Button sendButtonOff = (Button) findViewById(R.id.buttonoff);
        ...
        Button realTimeGraphic = (Button) findViewById(R.id.realtTimeGraphButton);
    ...
    public void addGraph() {
        ...
        final StepGraphWidget graph = new StepGraphWidget(this);
