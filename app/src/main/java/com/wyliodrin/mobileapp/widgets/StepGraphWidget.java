 ...
 */
public class StepGraphWidget extends XYPlot implements InputDataWidget {
    ...
    public StepGraphWidget(Context context, AttributeSet attrs) {
        super(context, attrs);

        series = new GraphWidgetDataSeries();

        StepFormatter formatter = new StepFormatter(Color.argb(100, 0, 200, 0), Color.rgb(0, 80, 0));
...
//        setRenderMode(RenderMode.USE_BACKGROUND_THREAD);
    ...
    public StepGraphWidget(Context context) {
        this(context, null);
    }
